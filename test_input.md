...
The ``cgb_input_generator`` input file is specified in JSON format, which essentially defines elements as dictionaries and lists thereof. The JSON file contains five primary entries (TF, motifs, genomes (generated by `cgb_input_generator`), input_parameters, and cgb_parameters). The following sections detail each of these.
 ...
 * Name (Generated by ``cgb_input_generator``)
   * The name given to the motif. By convention, `TFname_SpeciesAbbr`
   * `"name" : "TF_SpecAbb"`
 * Protein accession (**Needs to be in the `cgb_input_generator` input file**)
   * The NCBI accession.version identifier of the TF 
   * `"protein_accession : "WP_000000.0"`
 * Sites (**Needs to be in the `cgb_input_generator` input file**)
...
## Genomes (Created and populated by ``cgb_input_generator``)
